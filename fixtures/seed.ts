...
export const ISSUES: Issue[] = [
  ...
  mk(
    ...
    [
      cm(
        "Maya Chen",
        "maya",
        "Let us keep it to 4 steps max so it does not feel like a chore.",
        "1h ago",
      ),
    ],
  ),
  mk(
    151,
    "Usage-based billing meter in dashboard",
    "planned",
    "dev",
    "Billing",
    ["feature", "frontend"],
  ...
  mk(
    142,
    "Add passkey (WebAuthn) login option",
    "planned",
    "aisha",
    "Auth Revamp",
    ["feature", "backend"],
    ...
    [
      cm(
        "Aisha Khan",
        "aisha",
        "Scoping the registration ceremony first, sign-in flow follows.",
        "1d ago",
      ),
    ],
  ),
  ...
  mk(
    ...
    [
      cm(
        "Dev Patel",
        "dev",
        "Dual-write is live in staging, p99 auth down ~40%.",
        "2h ago",
      ),
      cm(
        "Tom Lee",
        "tom",
        "Nice. Lets watch eviction metrics before prod.",
        "1h ago",
      ),
    ],
    [
      act("opened this issue", "4d ago"),
      act("moved to In Progress", "3d ago"),
      act("linked PR #312", "3h ago"),
    ],
  ),
  mk(
    144,
    ...
    [
      cm(
        "Maya Chen",
        "maya",
        "Pushed a first pass, grouping into Account / Workspace / Billing / Developer.",
        "5h ago",
      ),
    ],
  ...
  mk(
    ...
    [
      cm(
        "Sam Rivera",
        "sam",
        "Shipped, looks great. Contrast all passes AA.",
        "2d ago",
      ),
    ],
  ...
  mk(
    133,
    "Fix flaky CI on integration tests",
    "done",
    "tom",
    "Performance",
    ["infra", "bug"],
